...
model2 = SentenceTransformer("sentence-transformers/all-MiniLM-L6-v2")  # Zweites Modell, hier als Beispiel
...
plt.plot(index_values, similarity_scores_model2, marker='x', color='green', label="Model 2 - all-MiniLM-L6-v2", linestyle='--')
